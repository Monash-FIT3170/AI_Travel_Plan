...
function updateLayer(map, id, props, prevProps) {
    ...
    var _a = props.layout, layout = _a === void 0 ? {} : _a, _b = props.paint, paint = _b === void 0 ? {} : _b, 
    // @ts-expect-error filter is not defined on some layer types
    filter = props.filter, minzoom = props.minzoom, maxzoom = props.maxzoom, beforeId = props.beforeId;
