...
export const mockEvent1 = {
  ...
  export const mockDaily_Itinerary2 = {
    day: 2,
    date: new Date("2023-05-27"),
    events: [mockEvent3, mockEvent4],
  };
  
  export const mockDaily_Itinerary3 = {
    day: 3,
    date: new Date("2023-05-28"),
    events: [mockEvent5],
  };
  
  export const mockDaily_Itinerary4 = {
    day: 4,
    date: new Date("2023-05-29"),
    events: [mockEvent6, mockEvent7],
  };
  
  export const mockDaily_Itinerary5 = {
    day: 5,
    date: new Date("2023-05-30"),
    events: [mockEvent8, mockEvent9, mockEvent10],
  };
  
  export const mockDaily_Itinerary6 = {
    day: 6,
