// This code was copy and pasted from Kai's branch in order to test the bridge from backend to frontend.
/*
This is a mock itinerary for a 6-day trip to Japan (Tokyo, Kyoto, Osaka)
*/

import { Event, Daily_Itinerary, Travel_Itinerary } from "./schema/chatMessage.schema";
