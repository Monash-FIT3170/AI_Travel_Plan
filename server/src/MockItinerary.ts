...
const mockEvent1: Activity = {
  ...
  location: "110-0007 Tokyo Ueno Park, Taito-ku, 5-20",
  description:
...
const mockDaily_Itinerary1: DailyItinerary = {
  day: 1,
  date: new Date("2023-05-26"),
  activities: [mockEvent1, mockEvent2],
};

const mockDaily_Itinerary2: DailyItinerary = {
  day: 2,
  date: new Date("2023-05-27"),
  activities: [mockEvent3, mockEvent4],
};

const mockDaily_Itinerary3: DailyItinerary = {
  day: 3,
  date: new Date("2023-05-28"),
  activities: [mockEvent5],
};

const mockDaily_Itinerary4: DailyItinerary = {
  day: 4,
  date: new Date("2023-05-29"),
  activities: [mockEvent6, mockEvent7],
};

const mockDaily_Itinerary5: DailyItinerary = {
  day: 5,
  date: new Date("2023-05-30"),
  activities: [mockEvent8, mockEvent9, mockEvent10],
};

const mockDaily_Itinerary6: DailyItinerary = {
  day: 6,
  date: new Date("2023-05-31"),
  activities: [mockEvent11, mockEvent12],
};
