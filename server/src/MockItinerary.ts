...
const mockEvent1: Event = {
    ...
    description: 'The Ueno park is officially called the “Ueno Imperial Gift Park “ because it was a gift from Emperor Taisho to Tokyo city as a place of public recreation. The park is rich with greenery and birds during winter. This park also includes many other attractions in it.',
...
const mockEvent2: Event = {
    ...
    description: 'The bustling neighborhood of Akihabara is one of the largest hubs for electronics retailers.',
...
const mockEvent3: Event = {
    ...
    description: 'Meiji Jingu Shrine in Tokyo is one of the numerous places which take you closer to the Japanese culture. It is a great destination to visit for those who love the old world charm.',
...
const mockEvent4: Event = {
    ...
    description: 'Harajuku is the trendiest shopping area in Tokyo. Shops full of funky and unique clothes and cafes make this area a popular hangout.',
...
const mockEvent5: Event = {
    ...
    description: 'It is a getaway into the world of fantasy and the rides are all filled with generous doses of cuteness and grandeur.',
...
const mockEvent6: Event = {
    ...
    description: 'Established in the year 778, the Kiyomizu-dera is located halfway up the Otowa Mountain in eastern Kyoko. ',
...
const mockEvent7: Event = {
    ...
    description: 'A district in Kyoto which is well known for its Bamboo Grove. It is situated along the base of the Arashiyama Mountains (Storm Mountains) and is a nationally-designated Historic Site.',
...
const mockEvent8: Event = {
    ...
    description: 'The Fushimi Inari-Taisha is an important Shinto shrine situated in southern Kyoto. It is the most important of several thousands of shrines dedicated to Inari, the Shinto god of rice.',
...
const mockEvent9: Event = {
    ...
    description: 'A Zen temple situated in the northern part of Kyoto. The top two floors of the temple are completely covered in gold leaf.',
...
const mockEvent10: Event = {
    ...
    description: 'A small charming alley running between Sanjo-dori and Shifo-dori, Pontocho is the place to be to gorge on delicious food. Said to be one of Kyoto most atmospheric dining areas, the alley is lined with many restaurants, dining rooms, tea houses and cafes. ',
...
const mockEvent11: Event = {
    ...
    description: 'With 1500 animals representing over 300 species, in a space spread out over 100 thousand square meters, the Tennoji Zoo is one of the largest in Japan.',
...
const mockEvent12: Event = {
    ...
    description: 'Dotonbori Area is one of Osaka most popular localities. It is a street that runs parallel to the Dotonbori canal. Having lots of malls, shops and restaurants around, it is a popular shopping and entertainment district. ',
...
const mockTravel_Itinerary1: Travel_Itinerary = {
    startDate: new Date('2023-05-26'),
    endDate: new Date('2023-05-31'),
    schedule: [mockDaily_Itinerary1, mockDaily_Itinerary2, mockDaily_Itinerary3, mockDaily_Itinerary4, mockDaily_Itinerary5, mockDaily_Itinerary6]
}